...
# This file was *autogenerated* from the file /Users/430b/Desktop/gbtac_experiments/Sage/Basis.sage
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i, j in product(range(len(set_list)), repeat=_sage_const_2 ):   
            # print(f"[DEBUG] i: {i}")
            # print(f"[DEBUG] j: {j}")
            f_i = set_list[i]
            f_j = set_list[j]
