...
example (x0 x1 : ℕ) (h₁ : x0 + x1 = 0) (h₂ : x0*x1 - 1 = 0)  : x1^2 + 1= 0 := by
  grind

example (x0 x1 : Nat) (h₁ : x0 + x1 = 0) (h₂ : x0*x1 - 1 = 0)  : x1^2 + 1= 0 := by
  grind
...
example : x4^15 + 122*x4^10 - 122*x4^5 - 1 = 0 := by grind
